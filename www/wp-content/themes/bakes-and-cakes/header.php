...
<meta charset="<?php bloginfo( 'charset' ); ?>">
    ...
    <meta property="og:image" content="http://rybkolhoz.ru/logo.jpg">
	    ...
	    <div class="header-t">
              ...
              if( function_exists( 'has_custom_logo' ) && has_custom_logo() ){
    			...
    			if ( $description || is_customize_preview() ) : ?>
                    ...
                    <span style="display: block; margin-top: -2em;"><b><a style="font-size:2.2em;color:#f6a8c6!important;" href="tel:+7978 872 45 14">+7978 872 45 14</a></b></span>
    			<?php endif; ?>
    		</div><!-- .site-branding -->
