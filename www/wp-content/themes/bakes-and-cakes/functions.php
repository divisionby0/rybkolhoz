...
include_once ("sections/CountersSectionAdmin.php");
include_once ("sections/ContactFormSectionAdmin.php");
include_once ("sections/AboutUsSectionAdmin.php");
include_once ("sections/GallerySectionAdmin.php");
include_once ("sections/AchievementsSectionAdmin.php");
include_once ("sections/ScheduleSectionAdmin.php");
 ...
 */
	function bakes_and_cakes_setup() {
		...
		*/
		...
		add_image_size('bakes-and-cakes-justtext-thumb', 600, 400, true);
