...
function bakes_and_cakes_customize_register( $wp_customize ) {
  ...
  /* Option list of all post */ 
    ...
    // to add new section need to add it into custom-functions.php line 295
    new CountersSectionAdmin($wp_customize,$options_pages);
    new ContactFormSectionAdmin($wp_customize,$options_pages);
    new AboutUsSectionAdmin($wp_customize,$options_pages);
    new GallerySectionAdmin($wp_customize,$options_pages);
    new AchievementsSectionAdmin($wp_customize,$options_pages);
    new ScheduleSectionAdmin($wp_customize,$options_pages);
